...
class NameJetCollector(BaseCollector):
    ...
    MOCK_DOMAINS = [
        ...
        },
        {
            ...
            "source": SOURCE,
            "dr": 29,
            "referring_domains": 256,
            "domain_age": 7,
        },
        {
            "domain_name": "gathr.org",
            "price": 14.0,
